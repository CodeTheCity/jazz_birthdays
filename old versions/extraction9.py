...
for child in root:
    ...
    if not ignore_flag:
        if child.text is not None:
            line_text = child.text.encode('utf-8')
            line_text = line_text.strip()
            line_text = remove_non_ascii_1(line_text)
