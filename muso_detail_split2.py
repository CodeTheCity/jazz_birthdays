...
def muso_detail_split(text):
  ...
  if worked:
    ...
    #return muso_forname, muso_midname, muso_surname, birth_year, instrm_list
    print muso_forname , muso_midname, muso_surname, birth_year, instrm_list
    return "1"
...
#line_text = 'Corky Hale, harp, piano, keyboards, flue vocal, 1936'
